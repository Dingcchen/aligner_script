...
def Initialize(SequenceObj, alignment_parameters, alignment_results):
    ...
    GantryController = HardwareFactory.Instance.GetHardwareByName('Gantry')
    GantryController.RunAeroBasicTask("SpiralFine")
    while (GantryController.taskStatus != GantryController.AeroTaskStatus.Complete): 
        sleep(1)
